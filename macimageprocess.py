...
def capture_and_analyze():
    """
    Capture image with webcam, wait 5 seconds, then run classification inference
    """
    global frame_count
    ...
    try:
        ...
        # Initialize webcam and capture image
...
def main():
    print("🚀 Starting SmartSort Webcam Classification")
    print("=" * 60)
    print("📋 Features:")
